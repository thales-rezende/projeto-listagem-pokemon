...
//apagar os comentários ao fim do código

// Após terminar o projeto ele fez uma "refatoração" (deixar o código mais limpo) e adicionou um ".toogle" no lugar do "add & remove" -> Anotação no NOTION
